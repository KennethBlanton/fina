...
class ImageDetail extends Component {
	...
	render() {
		...
		var thumblink = this.state.data && this.state.data.imagelink;
		...
		return (
			...
			<div>
				...
				<div className="Image__Details--Container">
					<img className="Image__Details--Image" src={`http://circuslabs.net/~michele.james/php/user_uploads/${thumblink}`} alt={this.state.data.description}/>					
